...
public class MainActivity extends Activity
{
    ...
    class MyAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                ...
                holder.textView = (com.example.gradientdemo.MyTextView) convertView.findViewById(R.id.tv);
    ...
    class ViewHolder
    {
        com.example.gradientdemo.MyTextView textView;
    }
